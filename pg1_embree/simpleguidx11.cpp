...
int SimpleGuiDX11::Init()
{
	...
	hwnd_ = CreateWindow( _T( "ImGui Example" ), _T( "PG1 Ray Tracer" ),
		WS_OVERLAPPEDWINDOW, 100, 100, 1600, 1000, NULL, NULL, wc_.hInstance, this );
...
Color4f SimpleGuiDX11::get_pixel( const int x, const int y, const int tid, const float t )
{
...
#pragma omp parallel for num_threads(4) collapse(2)
		for ( int y = 0; y < height_; ++y )
		{
			...
			{				
				...
				const Color4f pixel = get_pixel(x, y, omp_get_thread_num(), t);
...
int SimpleGuiDX11::MainLoop()
{
	...
	while ( msg.message != WM_QUIT )
	{
		...
		ImGui::SetWindowSize(ImVec2(width_ + 20, height_ + 40));
